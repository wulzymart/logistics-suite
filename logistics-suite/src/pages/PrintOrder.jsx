...
class ToBePrinted extends React.Component {
  ...
  // }
  render() {
    const { stations, order, customer, receiver, address } = this.props;
    return (
      <div>
        <div className="p-20">
          <div className="">
            <div className="flex w-full gap-24 items-center  justify-center mb-16">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-center text-md  text-[#ff2600] font-medium">
                  ...
                  Building Agasa Okene Kogi, Nigeria
                </p>
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="flex flex-col gap-3 w-full mb-8">
                ...
                <p>
                  Payment Status: {order.paid ? "Paid" : "Awaiting Payment"}
                </p>
              </div>
              <div className="flex flex-col gap-3 w-full mb-8">
                {order.deliveryType && (
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span>
                        {customer.address.lga ? customer.address.lga : ""}
                      </span>
                      <span>
              ...
              <div className="w-full border-solid border-2 border-gray-800  dark:border-white p-5">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div>
                    ...
                    <span>
                      {receiver.businessName ? receiver.businessName : ""}
                    </span>
                  </div>
                  <div className="flex gap-2">
                    <span className="font-medium">Address: </span>
                    <div className="flex flex-col">
                      ...
                      <span>
                        {receiver.address.lga ? receiver.address.lga : ""}
                      </span>
                      <span>
...
// const ToBePrinted = ({ stations, order, customer, receiver, address }) => {
//   return (
//     <div>
//       <div className="p-20">
//         <div className="">
...
const PrintOrder = () => {
  ...
  const { order, customer } = JSON.parse(localStorage.getItem("state"));
  const { receiver } = order;
  const address = stations[order.originStation]?.address;
  let componentRef = React.createRef();
  return (
    <>
      <div className="flex justify-end w-[80%] mx-auto mt-10">
        <ReactToPrint
          trigger={() => (
            <button className="bg-gray-400 px-4 py-1 rounded-lg">Print</button>
          )}
